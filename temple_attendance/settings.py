...
MONGODB_URI = os.environ.get('MONGODB_URI', 'mongodb+srv://bapspalanapurmandir_db_user:JZk14IqQigujWwCi@cluster0.qf8igco.mongodb.net/temple_attendance?retryWrites=true&w=majority&appName=Cluster0')
